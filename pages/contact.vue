<template>
    ...
    <div class="w-screen overflow-hidden">
        <div class="w-4/5 sm:w-2/3 md:w-1/2 mx-auto text-center">
            ...
            <p class="text-xl">
                If you wish to contact a member in particular, you can find our socials in our <NuxtLink to="/about" class="underline hover:brightness-200">About Us</NuxtLink>!
                <br><br>
        ...
        <div class="w-4/5 sm:w-2/3 md:w-1/2 mx-auto text-center mb-80">
            ...
            <p class="text-xl">
                If you wish to partner up with us on a project or have a business proposal, you can <a href="mailto:crunchmunchcreations@gmail.com" class="underline hover:brightness-200">shoot an email to us</a>!
                <br><br>
                We may take up to a week to respond.
            </p>
        </div>
    </div>
</template>
